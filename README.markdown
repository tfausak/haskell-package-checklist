...
GitHub allows other developers to easily contribute to
...
Stack painlessly manages Haskell dependencies. It
...
The default Cabal package file format is custom,
...
Keep everything lowercase to avoid confusion. You
...
Unfortunately Hackage recommends the Package
...
Nobody can use a package without a license. The
...
Most people will familiarize themselves with your package
...
Most packages will use Git tags to mark releases, but
...
This shows up when searching and viewing your
...
Only add a dependency if your package needs it
...
If a file is necessary for your package to
...
In other words, separate your package
...
Users should be able to get started with nothing more
...
People will want to use your package in
...
GHC finds all kinds of problems with `-Wall`. Few of
...
Overall HLint is a great tool for
...
hindent is the closest thing we have to a
...
Types are not a substitute for
...
Tasty provides a framework for running
...
Travis CI is free for open source projects and
...
If your package provides an executable, define it
...
If your package needs to be fast, Criterion is
...
Don't manually create distribution tarballs and upload
